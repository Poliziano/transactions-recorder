...
export type CreateTransactionsMachineParams = {
    fetchTransactions: (context: Context, event: FetchTransactionsEvent) => Promise<TransactionEntity[]>;

    createTransaction: (context: Context, event: CreateTransactionEvent) => Promise<TransactionEntity>;

    deleteTransaction: (context: Context, event: DeleteTransactionEvent) => Promise<TransactionEntity>;
};
